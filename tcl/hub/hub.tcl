...
#  Jan 22, 2020 01:23:59 PM GMT  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 403x496+2919+428
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab45 \
        ...
        -background #212121 -font {-family {Courier} -size 14} \
        -foreground #dddddd -highlightcolor black -justify left -text IP: 
    vTcl:DefineAlias "$top.lab45" "ip_addr_label" vTcl:WidgetProc "TcpMonitorHub" 1
    label $top.lab46 \
        -activebackground #f9f9f9 -activeforeground black -anchor w \
        -background #212121 -font {-family {Courier} -size 14} \
        -foreground #dddddd -highlightcolor black -justify left -text Port: 
    ...
    button $top.but44 \
        ...
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground #191919 -highlightcolor black -relief flat 
    vTcl:DefineAlias "$top.but44" "monitor_time_history_button" vTcl:WidgetProc "TcpMonitorHub" 1
    button $top.but45 \
        -activebackground #0068dd -activeforeground black -background #191919 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightbackground #191919 -highlightcolor black -relief flat 
    vTcl:DefineAlias "$top.but45" "monitor_profile_button" vTcl:WidgetProc "TcpMonitorHub" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lis43 \
    ...
    place $top.lab47 \
        ...
        -anchor nw -bordermode ignore 
    place $top.but44 \
        -in $top -x 340 -y 10 -width 56 -relwidth 0 -height 56 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but45 \
        -in $top -x 340 -y 70 -width 56 -height 56 -anchor nw \
        -bordermode ignore 
